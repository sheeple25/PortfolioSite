...
export const ENTRIES: readonly Entry[] = [
  {
    ...
    source: {
      ...
      meta: {
        ...
        tags: ["Research", "Speculative Design", "Academic"],
        // DRAFT — the registry had no `skills` for this entry at all, which
        // left the thesis (the one project held in the middle of the graph)
        // with nothing but domains hanging off it. These three are read off
        // the description and `sectionTitles` above — a research question, a
        // theoretical foundation, a method, and briefs written out of it —
        // not off a skills row on the page, because there isn't one. Verify.
        skills: ["Design Research", "Synthesis", "Concept Design"],
  ...
  },
  {
    ...
    source: {
      ...
      meta: {
        ...
        /* The hero is the studio's title card — right at full bleed, illegible
           at card size, and its pink rule fights the pink mark laid over it.
           The card gets a plain plate instead and draws the mark live. See
           `scripts/generate-card-covers.mjs`. */
        cardCover: "/archive/traces-card.webp",
        coverAlt:
        ...
        logoWidth: 14,
        tags: ["Research", "Speculative Design", "UI/UX"],
  ...
  },
  {
    ...
    source: {
      ...
      meta: {
        ...
        skills: ["User Research", "Concept Design", "CAD Modelling"],
        ...
        tags: ["Research", "Physical Product", "Client Work"],
  ...
  },
  {
    ...
    source: {
      ...
      meta: {
        ...
        /* The banner's crop wants the mark high in the frame (see below); a
           138×98 graph card crops nothing vertically and wants it centred.
           Generated by `scripts/generate-card-covers.mjs`. */
        cardCover: "/archive/vashi-card.webp",
